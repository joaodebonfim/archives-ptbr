...
Config.FuelPrice = 7            -- Price of the fuel per litre

Config.JerryCanCost = 80                                                   -- Cost of the Jerry Can
...
Config.RefillTimePerLitre = 2.0 -- Time in seconds to refill 1 litre of fuel
