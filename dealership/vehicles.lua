...
local Vehicles = {
    ...
    { model = 'issi5',           name = 'Issi Future Shock',             brand = 'Weeny',           price = 2500,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'patriot3',        name = 'Patriot Military',              brand = 'Mil-Spec',        price = 15000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'cavalcade3',      name = 'Cavalcade XL',                  brand = 'Albany',          price = 90000,  category = 'suvs',           type = 'automobile', shop = 'luxury' },
    ...
    { model = 'dominator7',      name = 'Dominator ASP',                 brand = 'Vapid',           price = 2500,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'ellie',           name = 'Ellie',                         brand = 'Vapid',           price = 4220,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet3',       name = 'Classic Gauntlet',              brand = 'Bravado',         price = 6500,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet4',       name = 'Gauntlet Hellfire',             brand = 'Bravado',         price = 4000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'gauntlet5',       name = 'Gauntlet Classic Custom',       brand = 'Bravado',         price = 6000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'buffalo4',        name = 'Buffalo STX',                   brand = 'Bravado',         price = 35000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    --- Sports Classic (5)
    { model = 'tampa2',          name = 'Drift Tampa',                   brand = 'Declasse',        price = 8000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'yosemite2',       name = 'Yosemite Drift',                brand = 'Declasse',        price = 15000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'ratloader2',      name = 'Ratloader',                     brand = 'Ratloader2',      price = 2000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'imperator',       name = 'Imperator Arena',               brand = 'Vapid',           price = 9500,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'hustler',         name = 'Hustler',                       brand = 'Vapid',           price = 9500,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'hotknife',        name = 'Hotknife',                      brand = 'Vapid',           price = 9000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'coquette3',       name = 'Coquette BlackFin',             brand = 'Invetero',        price = 5000,  category = 'sportsclassics',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'mamba',           name = 'Mamba',                         brand = 'Declasse',        price = 14000,  category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    ...
    { model = 'savestra',        name = 'Savestra',                      brand = 'Annis',           price = 32000,   category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    ...
    { model = 'ztype',           name = 'Z-Type',                        brand = 'Truffade',        price = 27000,  category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    ...
    { model = 'coquette2',       name = 'Coquette Classic',              brand = 'Invetero',        price = 16000,  category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    --- Sports (6)
    ...
    { model = 'imorgon',         name = 'Imorgon',                       brand = 'Överflöd',        price = 12000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'italigto',        name = 'Itali GTO',                     brand = 'Progen',          price = 26000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'ruston',          name = 'Ruston',                        brand = 'Hijak',           price = 13000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'schlagen',        name = 'Schlagen GT',                   brand = 'Benefactor',      price = 16000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'seven70',         name = 'Seven-70',                      brand = 'Dewbauchee',      price = 14000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'specter',         name = 'Specter',                       brand = 'Dewbauchee',      price = 16000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'italirsx',        name = 'Itali RSX',                     brand = 'Progen',          price = 26000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'stingertt',       name = 'Itali GTO Stinger TT',          brand = 'Maibatsu',        price = 23800,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'sm722',           name = 'SM722',                         brand = 'Benefactor',      price = 12500,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'tenf',            name = '10F',                           brand = 'Obey',            price = 18500,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'tenf2',           name = '10F Widebody',                  brand = 'Obey',            price = 110000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'prototipo',       name = 'X80 Proto',                     brand = 'Grotti',          price = 500000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'reaper',          name = 'Reaper',                        brand = 'Pegassi',         price = 100000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'sc1',             name = 'SC1',                           brand = 'Übermacht',       price = 400000,   category = 'super',          type = 'automobile', shop = 'luxury' },
    ...
    { model = 'tezeract',        name = 'Tezeract',                      brand = 'Pegassi',         price = 500000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    ...
    { model = 'vagner',          name = 'Vagner',                        brand = 'Dewbauchee',      price = 500000, category = 'super',          type = 'automobile', shop = 'luxury' },
    ...
    { model = 'shotaro',         name = 'Shotaro',                       brand = 'Nagasaki',        price = 3200,  category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    ...
    { model = 'powersurge',      name = 'Powersurge',                    brand = 'Western',         price = 6500,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    --- Off-Road (9)
    ...
    { model = 'caddy2',          name = 'Caddy (Golf)',                  brand = 'Nagasaki',        price = 30000,   category = 'utility',        type = 'automobile', shop = 'truck' },
    ...
    { model = 'inductor',        name = 'Inductor',                      brand = 'Coil',            price = 1000,    category = 'cycles',         type = 'bike',       shop = 'pdm' },
    { model = 'inductor2',       name = 'Junk Energy Inductor',          brand = 'Coil',            price = 1000,    category = 'cycles',         type = 'bike',       shop = 'pdm' },
    --- Boats (14)
